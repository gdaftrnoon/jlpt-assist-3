    ...
    const MobileHomepage = () => (
        <Container maxWidth='xl' sx={{ minHeight: 'calc(100vh - 56px)', backgroundColor: 'white' }}>
            <Box>
                ...
                <Card sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mt: 3, borderRadius: '16px' }}>
                    <Table>
                        <TableBody>
                            <TableRow>
                ...
                <Card sx={{ display: 'flex', flexDirection: 'column', mt: 6, borderRadius: '16px' }}>
                    ...
                    <CardContent sx={{ paddingBottom: 0 }}>
                        <Typography sx={{ fontSize: '0.85rem', color: 'grey.600' }}>語彙テーブルによって、まだ覚えていない単語やカスタムクイズで自分をテストしよう</Typography>
                    </CardContent>

                </Card>

                {/* card for quiz */}
                <Card sx={{ display: 'flex', flexDirection: 'column', mt: 3, borderRadius: '16px', flexDirection: 'column' }}>
