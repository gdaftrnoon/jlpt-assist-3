"use client"
import { Alert, Box, Button, Card, CardActionArea, CardContent, CardMedia, FormControlLabel, FormGroup, IconButton, Paper, Slide, Stack, Switch, Table, TableBody, TableCell, TableHead, TableRow, TextField, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material'
            ...
            <Box sx={{ display: 'flex', flex: 4, flexDirection: 'row', width: '100%', backgroundColor: 'white' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', flex: 2, minWidth: 856, backgroundColor: '' }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '100px', flexDirection: 'column' }}>
                        ...
                        <Typography gutterBottom variant='subtitle1' sx={{ color: 'grey', fontWeight: '50', textAlign: 'center' }}>語彙表の確認、知らない単語の記録</Typography>
                        <Typography variant='subtitle1' sx={{ color: 'grey', fontWeight: '50', textAlign: 'center' }}>カスタムクイズで効率的に復習しよう</Typography>
                    </Box>
                    ...
                    <Box sx={{ backgroundColor: '', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 780, paddingTop: 5, overflow: 'hidden', paddingBottom: 5 }}>
                        <Paper sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', minHeight: 730, flex: 1, minWidth: 420, maxWidth: 770, paddingBottom: 5, overflow: 'hidden' }}>
                            <Slide timeout={350} direction={activeExample === 'vocabtable' ? 'right' : 'left'} in={true} key={activeExample}>
                                    {(activeExample === 'vocabtable') ?
                                        ...
                                        <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '30px'}}>
                                            ...
                                            <Alert color='info' severity='info' sx={{ marginTop: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                {
                                            ...
                                            <Alert color='success' severity='success' sx={{ marginTop: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                <Typography>
